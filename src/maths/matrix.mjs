...
// export function createTranslation(x, y, z) {
//     const matrix = new Matrix();
...
// export function createOrthographic(width, height, near, far) {
//     if (!width || !height || !near || !far) {
//         throw new Error();
//     }
...
// export function createLookAt(cameraPosition, cameraTarget, cameraUp) {
//     const a = Vector3.subtract(cameraPosition, cameraTarget);
//     a.normalize();
...
//     const dotB = Vector3.dot(b, cameraPosition);
//     dotB.multiply(-1);
//     matrix.set(0, 3, dotB);
//     const dotC = Vector3.dot(c, cameraPosition);
//     dotC.multiply(-1);
//     matrix.set(1, 3, dotC);
//     const dotA = Vector3.dot(a, cameraPosition);
//     dotA.multiply(-1);
//     matrix.set(2, 3, dotA);
