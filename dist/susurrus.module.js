...
class Camera {
	constructor() {
		...
		this.worldViewProjection = Matrix.multiply(
			Matrix.multiply(this.view, this.world),
			this.projection
		);
	}
}

export { AttributeElement, AttributeSchema, attributeTypes as AttributeType, BasicEffect, Camera, colorProxy as Color, colors as Colors, drawModes as DrawMode, DynamicMatrix, Effect, IndexBuffer, Matrix, Polygon, PolygonData, Sketch, Vector3 as Vector2, Vector3, Vector3 as Vector4, VertexBuffer, vertexUsage as VertexUsage };
