    ...
    setData(data) {
        ...
        switch (this.type) {
            case BufferType.VERTEX: {
                WebGL.setVertexBufferData(__classPrivateFieldGet(this, _graphics).gl, this.buffer, this.data);
                break;
            }
            case BufferType.INDEX: {
                WebGL.setIndexBufferData(__classPrivateFieldGet(this, _graphics).gl, this.buffer, this.data);
                break;
            }
            default: {
