...
export default class Polygon {
	...
	updateBuffer() {
		...
		bufferData = bufferData.concat(
			__classPrivateFieldGet(this, _position).toArray()
		);
		bufferData = bufferData.concat(
			__classPrivateFieldGet(this, _scale).toArray()
		);
		bufferData = bufferData.concat(
			__classPrivateFieldGet(this, _rotationOffset).toArray()
		);
		bufferData = bufferData.concat(__classPrivateFieldGet(this, _rotation));
		bufferData = bufferData.concat(
			__classPrivateFieldGet(this, _color).toArray()
		);
