 ...
 */
export declare function expectType(value: any, type: string, options?: any): boolean | undefined;
/**
 ...
 * @param options Optional options to apply if validation fails.
 */
export declare function expectInstance(value: any, instance: any, options?: any): boolean | undefined;
